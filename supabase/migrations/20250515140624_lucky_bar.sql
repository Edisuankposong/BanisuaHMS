/*
  ...
  1. Changes
    - Creates a helper function to generate random dates between Dec 2024 and May 2025
    - Updates dates across all tables to reflect recent timeline
    - Maintains logical relationships between related dates
    - Removes tables that don't exist in the schema

  2. Notes
    - Ensures created_at is always before updated_at
    - Maintains logical sequence for appointment and prescription dates
    - Handles nullable date fields appropriately
*/
