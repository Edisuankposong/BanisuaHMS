/*
  ...
  1. Changes
    - Updates patient names to traditional Calabar/Cross River names
    - Updates email addresses to match new names
    - Updates emergency contact names to maintain cultural consistency

  2. Notes
    - Uses array-based updates to handle UUID comparisons
    - Maintains data integrity by using CASE statements
*/
